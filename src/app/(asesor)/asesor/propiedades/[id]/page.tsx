  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-base font-medium leading-snug text-slate-800">{propiedad.titulo}</h1>
      ...
      <a
        ...
        className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-emerald-700 active:translate-y-px"
      >
