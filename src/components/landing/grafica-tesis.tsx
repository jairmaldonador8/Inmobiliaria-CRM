 ...
 *
 * Arranca cuando la sección entra en pantalla, una sola vez. Los retrasos de
 * cada punto están calculados contra un barrido lineal de 1800 ms, así que
 * la luz «toca» el punto justo cuando aparece. Las animaciones viven en
 * globals.css (`.tesis-*`) para no repetir keyframes por render.
 */
export function GraficaTesis() {
  ...
  return (
    <div ref={ref} className={corriendo ? 'tesis-go' : undefined}>
